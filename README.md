...
**SignBridge ML API** is a standalone serverless microservice designed to power the computer vision capabilities of [SignBridge V2](https://github.com/Pro1943/SignBridgeV2). 
...
{
  "status": "ok",
  "message": "SignBridge ML Classifier API is running"
}
```
